...
public class ProfessorResearchStrategy implements  DatabaseResponseStrategy{
    @Override
    public String process(String content,String witaiValue) {
        //List<CourseInfoBean> courseInfoList = new Gson().fromJson(content, new TypeToken<List<CourseInfoBean>>() {}.getType()) ;
...
//            content = content+"comments    : " +course.getComments()+"\n";
//        }
        return content;
    }
}
